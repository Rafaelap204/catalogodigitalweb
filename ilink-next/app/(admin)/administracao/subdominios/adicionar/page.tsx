...
import { criarSubdominio } from '@/lib/server/actions/subdominios';
...
export default function AdicionarSubdominioPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const resultado = await criarSubdominio(formData);
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <div className="flex items-center gap-3 mb-4 sm:mb-0">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Adicionar Subdomínio</h1>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          {sucesso ? (
            <div className="p-8 text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Subdomínio cadastrado com sucesso!</h2>
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input type="text" id="subdominio" name="subdominio" required placeholder="ex: minhaloja" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 lowercase" />
                ...
                {tipo === 1 && (
                  <div>
                    <label htmlFor="rel_id" className="block text-sm font-medium text-gray-700 mb-2">Estabelecimento: *</label>
                    <input type="number" id="rel_id" name="rel_id" required placeholder="ID do estabelecimento" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" />
                  </div>
                )}
                ...
                {tipo === 2 && (
                  <>
                    ...
                    <div>
                      ...
                      <select id="rel_id" name="rel_id" required disabled={!estadoSelecionado} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100">
                ...
                {(tipo === 3 || tipo === 4) && (
                  <div>
                    ...
                    <input type="url" id="url" name="url" required placeholder="https://..." className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" />
                  </div>
                )}
              </div>
