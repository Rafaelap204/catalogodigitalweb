...
import { criarEstado } from '@/lib/server/actions/estados';

export default function AdicionarEstadoPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const resultado = await criarEstado(formData);
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <div className="flex items-center gap-3 mb-4 sm:mb-0">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Adicionar Estado</h1>
          </div>
